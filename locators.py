...
class Locators:
    ...
    FORGOT_PASS_BUTTON = (By.XPATH, "//button[text()='Восстановить пароль']") # Кнопка "Восстановить пароль", переход на форму восстановления пароля
    ...
    LOGIN_BUTTON = (By.CLASS_NAME, "Auth_login__3hAey") # Кнопка "Войти" в форме авторизации
    KONSTRUCTOR_BUTTON = (By.XPATH, "//ul[@class='AppHeader_header__list__3oKJj']/li[1]/a") # Кнопка "Конструктор", переход из ЛК в конструктор
    LOGO = (By.XPATH, "//ul[@class='AppHeader_header__list__3oKJj']/li[3]/a") # Логотип (переход из ЛК в конструктор)
    LOGOUT = (By.XPATH, "//button[text()='Выход']") # Кнопка "Выход", выход их аккаунта в ЛК
    BUNS = (By.XPATH, "//span[text()='Булки']/parent::div")
    SAUСES = (By.XPATH, "//span[text()='Соусы']/parent::div")
